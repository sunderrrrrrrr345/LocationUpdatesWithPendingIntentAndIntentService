        ...
        if (intent != null) {
            ...
            if (ACTION_PROCESS_UPDATES.equals(action)) {
                ...
                if (result != null) {
                    ...
                    Log.i("TAG123456789", Utils.getLocationUpdatesResult(this));
                    Toast.makeText(getApplicationContext(),Utils.getLocationUpdatesResult(this), Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
